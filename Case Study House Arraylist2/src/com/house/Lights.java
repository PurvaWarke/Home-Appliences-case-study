...
public class Lights extends Devices implements Switchable{
	...
	public Lights(int deviceId, String name, LocalTime time) {
	...
	public void getDeviceTime() {
		...
		if(this.getStatus()==true)
		{
			...
			if(timeDiff > 60)
			{
				...
				System.out.println("Light is Turn On "+min+" Min Ago !!");
			}
			else if(min > 60)
			{
				hr=duration.toHours();
				System.out.println("Light is Turn On "+hr+" Hours Ago !!");
			}
			else
			{
				System.out.println("Light is Turn On "+timeDiff+" Sec Ago !!");
			}
		}
		else
